...
func TestHasCycle(t *testing.T) {
	...
	for _, data := range getTestDataSet() {
		assert.Equal(t, data.answer, detectCycle(data.head))
	}
}
...
func getTestDataSet() []TestCaseDataSet {
	...
	return []TestCaseDataSet{
		...
		{node21, node21},
		{nil, &ListNode{Val: 1}},
		{nil, &ListNode{Val: 1, Next: &ListNode{Val: 2}}},
		{nil, &ListNode{Val: 1, Next: &ListNode{Val: 2, Next: &ListNode{Val: 3}}}},
	}
}
